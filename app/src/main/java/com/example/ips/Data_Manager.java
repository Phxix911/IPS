...
public class Data_Manager extends AppCompatActivity {
    ...
    private List<List<ScanResult>> wifiScanResultsList = new ArrayList<>();
    ...
    public void collectData() {
        ...
        Location locationData = sensorDataCollector.getLastLocation();
        if (locationData != null) {
            locationDataList.add(locationData);
        }

//        List<ScanResult> wifiScanResults = sensorDataCollector.getWifiScanResults();
...
//        }
    ...
    public List<List<ScanResult>> getWifiScanResultsList() {
