...
public class Switch extends PermissionManager implements SensorEventListener {
    ...
    public void start_record(View view){
        ...
        data_manager_top.collectData();
        Toast.makeText(this,"Sensors have started to record data", Toast.LENGTH_LONG).show();
    }
    public void start_visualize(View view){
        transaction = fm.beginTransaction();
        record_frag=new Recording_frag();
        transaction.replace(R.id.fragment,record_frag);
        transaction.commit();
    }
    public void stop_visualize(View view) {
        transaction = fm.beginTransaction();
