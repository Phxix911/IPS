...
public class SensorDataCollector implements SensorEventListener, LocationListener {
    ...
    public void startCollecting() {
        ...
        TrajectoryTop.setAndroidVersion(Build.VERSION.RELEASE);
        TrajectoryTop.setStartTimestamp(System.currentTimeMillis());
        TrajectoryTop.setDataIdentifier("Identifier");
        try {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if(event.sensor.getType()==Sensor.TYPE_ACCELEROMETER) {
            ...
            if(lastAccelerometer[0] <= 55 && lastAccelerometer[1] <= 55 && lastAccelerometer[2] <= 55){
        ...
        if (Rot_flag & Acc_flag & Gyro_flag){
